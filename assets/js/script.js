function mostrar(e) {
    if (e.classList.contains("fa-moon-o")) { 
        ...
        document.querySelector('.headi').style.color = '#fff';
        document.querySelector('.headi2').style.color = '#fff';
        ...
        document.querySelector('.headi').style.color = 'rgb(99, 99, 99)';
        document.querySelector('.headi2').style.color = 'rgb(99, 99, 99)';
